...
function SubmitButton() {
  ...
  return (
    <button
      ...
      disabled={pending}
      className={cn(
        "inline-flex h-12 w-full items-center justify-center gap-2 rounded-full bg-blue px-6 text-[15px] font-medium text-white transition-all",
        "shadow-[0_8px_24px_-12px_rgba(37,99,235,0.65)] hover:bg-blue-soft hover:-translate-y-0.5",
...
export function Contact() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute -bottom-32 left-1/2 h-[480px] w-[900px] -translate-x-1/2 glow-blue opacity-70"
        aria-hidden
      />
      ...
      <div className="container-narrow relative">
        <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
          ...
          {state.ok && state.message ? (
            ...
            >
              <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-green/15 text-green-soft">
...
function Field({ label, name, placeholder, type = "text", error, className }: FieldProps) {
  return (
