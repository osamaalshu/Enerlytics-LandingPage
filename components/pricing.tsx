          ...
          {tiers.map((t) => (
            <div
              ...
              className={cn(
                ...
                t.popular
                  ? "border-blue/40 shadow-[0_24px_60px_-20px_rgba(37,99,235,0.35)] lg:-translate-y-3"
                  : "border-navy/10 shadow-[var(--shadow-card)]",
              )}
            >
              {t.popular && (
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-blue px-3 py-1 text-[10.5px] font-semibold uppercase tracking-[0.18em] text-white">
                  Most popular
                </span>
              )}
